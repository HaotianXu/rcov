...
> names_lg = c("Ele MoM", "Ele T", "Ele AH", "Spec T")
> # Names of the distributions (in the order norm, pareto, log-norm, t4)
> names_dist = c("Normal", "Pareto", "Log-Normal", "Student ($df = 4$)")
> # Some colors
> mygrey = "grey85"
...
+ 
+   for (i in 1:4){
+     text(2 + 6*(i-1), 1.25, "n = 50", cex = 0.9)
+     text(5 + 6*(i-1), 1.25, "n = 100", cex = 0.9)
+   }
+ 
...
+   mtext("Dimension $p$", side = 1, line = 3, cex = 1)
+ }
\end{Sinput}
\end{Schunk}
...
> ele_T = cbind(t(table1_n50[c(2,6,8),1:3]), t(table1_n100[c(2,6,8),1:3]), t(table1_n50[c(2,6,8),4:6]), t(table1_n100[c(2,6,8),4:6]), t(table1_n50[c(2,6,8),7:9]), t(table1_n100[c(2,6,8),7:9]), t(table1_n50[c(2,6,8),10:12]), t(table1_n100[c(2,6,8),10:12]))#matrix(rep(1, 24*3) - runif(24*3), 3, 24)
