...
\begin{Schunk}
\begin{Sinput}
> load("~/GitHub/rcov/simulations/AutoCov_Simu/Data_LP_n50/LP_n50_lag0_rel.rda")
> table1_n50 <- table1
> load("~/GitHub/rcov/simulations/AutoCov_Simu/Data_LP_n100/LP_n100_lag0_rel.rda")
> table1_n100 <- table1
\end{Sinput}
\end{Schunk}
