...
save(table1, table2, table3, file = "VAR1_n50_lag0.rda")
...
save(table4, table5, table6, file = "VAR1_n50_lag1.rda")
...
save(table7, table8, table9, file = "VAR1_n50_lag2.rda")
...
save(table1, table2, table3, file = "VAR1_n50_lag0_abs.rda")
...
save(table4, table5, table6, file = "VAR1_n50_lag1_abs.rda")
...
save(table7, table8, table9, file = "VAR1_n50_lag2_abs.rda")
